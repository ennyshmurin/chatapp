...
public class ChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FloatingActionButton btn = findViewById(R.id.addMessageButton);
    ...
    private void sendCloudMessage(chatMessage m) {
        String serverKey = "AAAAk3dhGl8:APA91bF_fq4_eCwh4SIQ-4wfKgPsqqHhFRxAAo9mJ2bTweMpiKhepIhrXTD9g-zZe4o0Xhivha9iOqLiUr1AqmrTupZBA3HzmwFab6LWK9dsTnJ8cH6FHYVRggaugafaUoYdBPDjKiW0";
        String topic = "chat";
